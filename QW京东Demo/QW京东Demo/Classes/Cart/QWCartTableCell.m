...
@implementation QWCartTableCell
...
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    if (cell == nil) {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"QWCartTableCell" owner:nil options:nil] lastObject];
    }
...
- (void)setCellItems:(NSMutableArray *)cellItems forIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([cellItems[indexPath.row] isEqualToString:QW_YES_string]) {
