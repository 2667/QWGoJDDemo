...
#define QWToolBarButtonFontSize         [UIFont systemFontOfSize:17]
#define QWToolBarButtonFontSizeSmall    [UIFont systemFontOfSize:14]
#define QWPriceLabelWidth               170

@interface QWCartToolbar ()
...
- (void)addSubviews {
    ...
    _selectButton = [self addOneButtonWithTitle:@"全选"
                                      titleFont:QWToolBarButtonFontSizeSmall
    ...
    _totalPriceView = [self addOneButtonWithTitle:@""
                                        titleFont:QWToolBarButtonFontSize
                                            image:nil
                                    selectedImage:nil];
...
- (void)layoutSubviews {
    ...
    CGFloat selectX = 0;
    CGFloat selectY = 0;
    CGFloat selectWidth = (self.width - QWPriceLabelWidth) * 0.5;
    CGFloat selectHeight = self.height;
    _selectButton.frame = CGRectMake(selectX, selectY, selectWidth, selectHeight);
    // 合计
    CGFloat countX = CGRectGetMaxX(_selectButton.frame);
    CGFloat countY = 0;
    CGFloat countWidth = QWPriceLabelWidth;
    CGFloat countHeight = self.height;
