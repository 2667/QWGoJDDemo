...
@implementation QWCategoryListToolBar
...
- (instancetype)init {
    ...
    CGFloat height = 35;
    CGFloat originY = 44 + QWStatusBarHeight - 3;
...
- (void)addButtonWithTitle:(NSString *)title
             ...
             selectedImage:(UIImage *)selectedImage
                    target:(id)target
                    action:(SEL)action {
    QWCategoryBarButton *button = [QWCategoryBarButton buttonWithType:UIButtonTypeCustom];
    // 设置标题
