...
@interface QWImageScrollController ()
// 流水布局
...
@implementation QWImageScrollController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[QWImageScrollBaseCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (pageNum != currentPageNumber) {
        ...
        // 发出通知
        [[NSNotificationCenter defaultCenter] postNotificationName:QWPageNumberDidChangeNotification object:nil];
    }
}
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    QWImageScrollBaseCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
