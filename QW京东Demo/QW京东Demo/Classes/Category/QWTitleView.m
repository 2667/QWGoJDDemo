...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        [self addButtons];
        // 监听页面滚动位置
        [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(changeSelectedButton:) name:QWCurrentPageDidChangeNotification object:nil];
...
- (instancetype)init {
    ...
    CGFloat originX = 0;
    CGFloat originY = 0;
    CGFloat width = QWMainScreenBounds.size.width / 3;
    CGFloat height = 44;
