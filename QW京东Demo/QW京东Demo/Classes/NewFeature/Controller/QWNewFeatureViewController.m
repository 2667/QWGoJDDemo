...
- (void)viewDidLoad {
    ...
    // 注册cell
    [self.collectionView registerClass:[QWNewFeatureCell class] forCellWithReuseIdentifier:reuseIdentifier];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
     ...
     * 3. 如果发现没有注册，就会报错
     */
    QWNewFeatureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
